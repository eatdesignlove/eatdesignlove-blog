...
const About = () => (
  <Layout>
    ...
    <div className={styles.container}>
      ...
      <p className={styles.desc}>
        재미있는 아이디어를 떠올리고 실제로 구현하는 과정을 통해 사람들에게 긍정적인 영감을 주기를 꿈꾸고, 기술과 디자인이 그 도구가 될 수 있다고 믿습니다.
      </p>
      <p className={styles.desc}>
        현재는 크라우드펀딩 서비스 와디즈에서 프론트엔드 개발을 하며 새로운 시대에 영감을 주는 트렌디한 제품의 탄생을 돕고 있습니다.
      </p>
    </div>
